...
//            System.out.println(query);
            ...
            ResultSet rs = stm.executeQuery(userIdQuery);
            while(rs.next()) {
            	user_id = rs.getInt("id");
            }
            String defaultProj1 = "insert into Project_Users values('" + 1001+"'" + "," +user_id  + ")"; 
            String defaultProj2 = "insert into Project_Users values('" + 1002 + "'"+ "," + user_id + ")"; 
            System.out.println(defaultProj1);
            
            stm.executeUpdate(defaultProj1);
            stm.executeUpdate(defaultProj2);
        }catch(Exception e)
        {
            e.printStackTrace();
        }
