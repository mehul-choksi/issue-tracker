...
public class BugTracker extends JFrame {
	...
	public BugTracker() {
		...
		icon = new ImageIcon("/home/ash/workspace/mehul/TE/SDLProject_VFinal_final/res/image.png");
		iconHolder = new JLabel();
		iconHolder.setIcon(icon);
		iconHolder.setBounds(30, 30, 170, 170);
		//Welcome header
		
		welcomeHeading = new JLabel("Welcome to BugTracker!");
		welcomeHeading.setBounds(200,30, 400, 170);
